...
| `tokenhush privacy` | Lists every request Tokenhush itself can send to the internet, what the server sees, and how to turn each category off. Beyond those, the only traffic leaving your machine is your own requests to your provider. | `--json` |
