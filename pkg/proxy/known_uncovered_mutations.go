...
var knownUncoveredMutations = []string{
	...
	"a real invocation hidden as the argument of another command, or after a wrapper flag the wrapper list does not model (the indirect-execution class reached through the mention exemption)",
