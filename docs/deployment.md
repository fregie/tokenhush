...
On success it first prints the effective upstream route table and a `tokenhush env <tool>` onboarding hint, then the listening address and the control token file:
