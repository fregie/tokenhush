...
- **R6 — the envelope split is the upstream's choice; complete-envelope content
  ...
  stream and a split foreign placeholder stay byte-identical. The latency
  ...
  restore. Neither residual conceals a secret from a third party: the client is
